...
router.post("/like/:postId", authenticateUser, likeUnlikePost,ApiErrorResponseHandler);
router.post("/comment/:postId", authenticateUser, commentOnPost,ApiErrorResponseHandler);
router.delete("/:id", authenticateUser, deletePost);
router.get("/all", authenticateUser, getAllPosts);
router.get("/following", authenticateUser, getAllFollowingPosts);
router.get("/posts/:id", authenticateUser, getUserPosts);
